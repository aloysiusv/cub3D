...
** 
** Started on  Mon Jul 31 17:29:02 2000 Charlie zz
** Last update Thu Oct  4 15:44:43 2001 Charlie zz
*/
...
void	*mlx_new_window(t_xvar *xvar,int size_x,int size_y,char *title)
{
	...
	*/
	...
	if (!(new_win = malloc(sizeof(*new_win))))
		return ((void *)0);
	new_win->window = XCreateWindow(xvar->display,xvar->zz,0,0,size_x,size_y,
